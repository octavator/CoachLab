...
*/var SelectInput=function(_React$Component3){_inherits(SelectInput,_React$Component3);function SelectInput(props){_classCallCheck(this,SelectInput);var _this5=_possibleConstructorReturn(this,(SelectInput.__proto__||Object.getPrototypeOf(SelectInput)).call(this,props));_this5.state={show_dropdown:false};return _this5}_createClass(SelectInput,[{key:"render",value:function render(){var _this6=this;return React.createElement("div",{className:"select-input-wrapper"},React.createElement("div",{className:"input-group"},React.createElement("label",{className:"input-label mt-1 "+(this.props.label?this.props.bold_label?"bold":"":"hidden")},this.props.label),React.createElement("div",{className:"cl-select "+(this.props.extraClass?this.props.extraClass:"text-3"),onClick:function onClick(){return!_this6.props.disabled&&_this6.setState({show_dropdown:!_this6.state.show_dropdown})}},React.createElement("div",{className:"cl-selected-option"},this.props.value,React.createElement("i",{className:"fa fa-angle-"+(this.state.show_dropdown?"up":"down")+" "+(this.props.disabled?"hidden":"")})),React.createElement("div",{className:"cl-options-container "+(this.state.show_dropdown?"":"hidden")},this.props.options.map(function(option,option_idx){return React.createElement("div",{key:option_idx,className:"cl-option",onClick:function onClick(){return _this6.props.onClick(option.value)}},option.label)})))))}}]);return SelectInput}(React.Component);/*
  FileInput component
...
*/var RadioButton=function(_React$Component6){_inherits(RadioButton,_React$Component6);function RadioButton(props){_classCallCheck(this,RadioButton);var _this11=_possibleConstructorReturn(this,(RadioButton.__proto__||Object.getPrototypeOf(RadioButton)).call(this,props));_this11.state={};return _this11}_createClass(RadioButton,[{key:"render",value:function render(){var _this12=this;return React.createElement("div",{className:"input-group"},React.createElement("label",{className:"input-label mt-1 "+(this.props.label?this.props.bold_label?" bold":"":" hidden")},this.props.label),React.createElement("div",{className:"radio-choices"},React.createElement("div",{className:"radio-choice "+(this.props.disabled&&!this.props.value?"hidden":""),onClick:function onClick(){return _this12.props.onClick(true)}},React.createElement("label",{className:"radio-label "+(this.props.yesLabel?"":"hidden")},this.props.yesLabel||""),React.createElement("div",{className:"cl-radio ml-1 "+(this.props.value?"selected":"")},React.createElement("div",{className:"cl-radio-inner"}))),React.createElement("div",{className:"radio-choice "+(this.props.disabled&&this.props.value?"hidden":""),onClick:function onClick(){return _this12.props.onClick(false)}},React.createElement("label",{className:"radio-label "+(this.props.noLabel?"":"hidden")},this.props.noLabel||""),React.createElement("div",{className:"cl-radio ml-1 "+(!this.props.value?"selected":"")},React.createElement("div",{className:"cl-radio-inner"})))))}}]);return RadioButton}(React.Component);/*
  Button component
