          ...
          <div className="landing-info-card-section">
            <div className="landing-info-card">
              ...
              <div className="landing-info-card-text text-3">
                Un agenda interactif, qui vous aide à organiser et à planifier vos coachings à votre convenance,
                 avec inscription de vos coachés directement sur la plateforme, selon vos disponibilités.
              </div>
            </div>
            <div className="landing-info-card">
              <div className="landing-info-card-picto">
            ...
            <div className="landing-info-card">
              ...
              <div className="landing-info-card-text text-3">
                Une facturation automatique et instantanée de vos coachings, vous permettant de gagner du temps 
                et de vous concentrer sur votre activité uniquement. 
              </div>
            </div>
          </div>
